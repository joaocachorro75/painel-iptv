...
# Roda via cron do OpenClaw

cd /home/node/.openclaw/workspace-becloud/painel-iptv

# Buscar dados do RaioFlix e enviar pro painel
python3 << 'PYTHON'
import json
...
req = urllib.request.Request(
    ...
    data=json.dumps({"customers": all_customers, "resellers": resellers, "servers": servers, "packages": packages}).encode(),
